        ...
        return (
            <div>
                ...
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_result.jpg"} width={"20%"} height={"40%"} alt="" /><br />
                </Typography>
                ...
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/choose_tbc.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                    When the Tab Bar Controller is added, it has 2 boards connected as default. Of course you can replace this.<br />
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_created.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                </Typography>
                <Typography className={style.textColor} variant="h5" paragraph>
                ...
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_items_connected.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                </Typography>
                <Typography className={style.textColor} variant="h5" paragraph>
                ...
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_item_configure.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                </Typography>
                <Typography className={style.textColor} variant="h5" paragraph>
                    Run the project
                </Typography>
                ...
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_create_class.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_link_class.jpg"} width={"60%"} height={"40%"} alt="" /><br />
                </Typography>
                <Typography className={style.textColor} paragraph>
                    ...
                    <img src={"https://training.aizero.com.au/assets/images/apple/tbc_badge.jpg"} width={"20%"} height={"40%"} alt="" /><br />
                </Typography>
                <Typography className={style.textColor} paragraph>
